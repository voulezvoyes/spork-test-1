...
function SporkIcon({ size = 20, spinning = false, dark = false }) {
  ...
  return (
    ...
    >
      ...
      <path
        d="M35 36 Q35 44 47 46 Q59 44 59 36"
        fill="none"
        stroke={stroke}
        strokeWidth="4"
        strokeLinecap="round"
...
export default function Spork() {
  ...
  const [sessions] = useState([
    {
      id: "s1",
      title: "진로 고민",
      preview: "퇴사를 먼저 해야 할까...",
      branches: 3,
    },
    {
      id: "s2",
      title: "소개글 작성",
      preview: "LA에 사는 한국계 미국인...",
      branches: 2,
    },
    {
      id: "s3",
      title: "앱 이름 아이디어",
      preview: "AI 챗봇에 대화 브랜치...",
      branches: 5,
    },
    {
      id: "s4",
      title: "코드 디버깅",
      preview: "TypeError: cannot read...",
      branches: 1,
    },
    {
      id: "s5",
  ...
  const send = useCallback(async () => {
    ...
    /*
      IMPORTANT:
      specific branch intents are checked first.
      Otherwise words like "여행" would catch the message
      before "럭셔리" / "저예산".
    */
    ...
    if (
      ...
      reply =
        ...
        "원하면 이 브랜치에서 호텔, 레스토랑, 하루별 예상 비용까지 더 구체화해볼 수 있어.";
    }
      ...
      >
        ...
        <div
          style={{
            ...
            animation:
              "float 16s ease-in-out infinite reverse",
          }}
        />
        ...
        <div
          style={{
            ...
            animation:
              "float 20s ease-in-out infinite 4s",
          }}
        />
          ...
          >
            <div
              style={{
                ...
                boxShadow:
                  "0 0 20px rgba(0,0,0,0.06), inset 0 1px 0 rgba(0,0,0,0.12)",
              }}
            >
              <SporkIcon
                size={18}
              ...
              >
                <div
                  style={{
                    ...
                    boxShadow:
                      "0 0 40px rgba(0,0,0,0.06), inset 0 1px 0 rgba(0,0,0,0.12)",
                  }}
                >
                  <SporkIcon
                    size={32}
              ...
              >
                <div
                  style={{
                    ...
                    boxShadow:
                      "0 0 16px rgba(255,255,255,0.05), inset 0 1px 0 rgba(0,0,0,0.1)",
                ...
                <div
                  style={{
                    ...
                    boxShadow:
                      msg.role === "user"
                        ? "0 4px 24px rgba(0,0,0,0.4), inset 0 1px 0 rgba(0,0,0,0.12)"
                        : "0 2px 12px rgba(0,0,0,0.3), inset 0 1px 0 rgba(0,0,0,0.08)",
                  ...
                  {[0,1,2].map(i => (
                    <div
                      ...
                      style={{
                        ...
                        animation:
                          `pulse 1.3s ${i * 0.18}s ease-in-out infinite`,
                      }}
                    />
                  ))}
                </div>
          ...
          >
            <div
              style={{
                ...
                boxShadow:
                  "0 4px 32px rgba(0,0,0,0.4), inset 0 1px 0 rgba(0,0,0,0.08)",
              }}
            >
              <textarea
                ref={taRef}
      ...
      >
        {treeOpen && (
          <div
            style={{
              ...
              boxShadow:
                "0 16px 48px rgba(0,0,0,0.6), inset 0 1px 0 rgba(0,0,0,0.1)",
        ...
        <button
          ...
          style={{
            ...
            boxShadow:
              "0 4px 24px rgba(0,0,0,0.5), inset 0 1px 0 rgba(0,0,0,0.12)",
